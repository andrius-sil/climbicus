...
model_path = os.path.join("/opt/project/predictor/", model_name)  # TODO: get rid of this opt/project
...
def load_and_predict(model_path, img):
    ...
    class_indices = load_obj("/opt/project/predictor/class_indices.pkl")
...
image_path = "/opt/project/predictor/DSC_3878.JPG"
